...
def remove_duplicates(parsestrlower):
    output = []
    seen = set()
    for value in parsestrlower:
        if value not in seen:
            ...
            seen.add(value)
    return output
parseunique = remove_duplicates(parsestrlower)
...
############################################################################
            ...
            for executelst, executelstre in zip(["!console","!whatistbot","!nosubgift","!nospam","!name","!nobackseat"],
            ...
            "Twerkrobot is a handmade bot coded in Python. Criogenesis, one of our mods, made it! sihaHype","/me Do not ask for a gifted sub even as a joke, you will be timed out as a warning and banned if you ask again sihaShark",
